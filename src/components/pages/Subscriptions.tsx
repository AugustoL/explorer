...
const EARLY_ADOPTER_START = EARLY_ADOPTER_PERIODS[0]?.start ?? new Date();
const EARLY_ADOPTER_END =
	EARLY_ADOPTER_PERIODS[EARLY_ADOPTER_PERIODS.length - 1]?.end ?? new Date();
			...
			<div className="page-card">
				...
				<div className="text-center mb-large">
					...
					<p className="page-subtitle">
						Sustainable, ethical funding for open-source blockchain
						infrastructure
					</p>
				</div>
				...
				<div className="subscriptions-intro">
					<p>
						OpenScan remains <strong>entirely free for all end-users</strong>.
						Revenue is sourced from projects, applications, tokens, and networks
						that recognize the value of the platform and wish to formally appear
				...
				{selectedSubscription && (
					<div className="subscriptions-category-info">
						<p className="subscriptions-category-description">
								...
								<div key={tier.tier} className="subscriptions-tier-card">
									<div className="subscriptions-tier-header">
										<h3 className="subscriptions-tier-name">
											Tier {Object.keys(tierMultipliers).indexOf(tier.tier) + 1}{" "}
											- {tier.tier}
										</h3>
										<div className="subscriptions-tier-price">
											<span className="subscriptions-price-amount">
									...
									{tier.tier !== "Backer" && (
										<div className="subscriptions-tier-note">
											Includes all {tier.tier === "Ally" ? "Partner" : "Backer"}{" "}
											benefits
										</div>
									)}
								</div>
						...
						<div className="subscriptions-early-adopter-content">
								...
								{EARLY_ADOPTER_PERIODS.map((period, idx) => {
									...
									return (
										...
										>
											...
											<span className="subscriptions-early-adopter-tier-month">
												{period.label}
											</span>
										</div>
									);
							...
							{earlyAdopterActive && (
								<p className="subscriptions-early-adopter-status">
									...
									- {getCurrentEarlyAdopterDiscount()! * 100}% discount
									available
								</p>
							)}
						</div>
												...
												<td key={idx}>
													...
													<div className="subscriptions-table-early-adopter-list">
														{tp.earlyAdopterPrices.map((ea, eaIdx) => (
															<div
																key={eaIdx}
																className="subscriptions-table-early-adopter-item"
															>
				...
				<div className="subscriptions-governance">
					...
					<p>
						Ally-tier subscribers gain voting power in our bi-annual roadmap
						planning sessions, where the OpenScan team and Allies collaborate to
					...
					<div className="subscriptions-roadmap-features">
						<div className="subscriptions-roadmap-item">
							...
							<p>
								Vote on which features and improvements get developed next based
								on community needs.
							</p>
						</div>
						<div className="subscriptions-roadmap-item">
							...
							<p>
								Help decide which blockchain networks OpenScan should support
								and integrate.
							</p>
						</div>
						<div className="subscriptions-roadmap-item">
							...
							<p>
								Participate in discussions about OpenScan's long-term vision and
								technical direction.
							</p>
						</div>
					</div>
				...
				<div className="subscriptions-how-to">
					...
					<div className="subscriptions-steps">
						<div className="subscriptions-step">
							...
							<div className="subscriptions-step-content">
								<h4>Make Payment</h4>
								<p>
									Send your subscription payment to the{" "}
									<strong>openscan-payment</strong> contract on Ethereum
									Mainnet.
								</p>
							</div>
						</div>
						<div className="subscriptions-step">
							...
							<div className="subscriptions-step-content">
								...
								<p>
									Create a PR to the explorer-metadata repository with your
						...
						<div className="subscriptions-step">
							...
							<div className="subscriptions-step-content">
								<h4>Get Verified</h4>
								<p>
									Once your payment is confirmed and PR is reviewed, your
					...
					<div className="subscriptions-cta-buttons">
						<a
							href="/1/address/openscan-payment.eth"
